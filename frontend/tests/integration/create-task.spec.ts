 ...
 *
 * Stubs used:
 * - tests/integration/stubs/sign-in-with-google-btn.component.ts - Fake Google authentication
 * - tests/integration/stubs/device-camera.service.ts - Returns test image from tests/integration/assets/test-img.jpg
 *
 * Mocks:
...
test('user can create a task', async ({ page }) => {
  ...
  // Uses stub device-camera.service.ts to return test image from tests/integration/assets/test-img.jpg
