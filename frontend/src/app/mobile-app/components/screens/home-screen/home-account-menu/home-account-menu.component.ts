...
import { HomeAccountMenuAction } from './home-account-menu.actions';

@Component({
  selector: 'ba-home-account-menu',
  templateUrl: './home-account-menu.component.html',
  styleUrls: ['./home-account-menu.component.scss'],
  imports: [UserAvatarComponent],
})
export class HomeAccountMenuComponent {
  ...
  signOut(): void {
    this.close();
    this.store.dispatch(new HomeAccountMenuAction.SignOut());
  }
}
